...
class Settings:
    ...
    # Container Detection
    DEVCONTAINER_MODE: bool = os.getenv("DEVCONTAINER_MODE", "False").lower() == "true"
    IN_CONTAINER: bool = os.path.exists("/.dockerenv") or os.getenv("CONTAINER", "False").lower() == "true"
    ...
    BINANCE_WS_BASE_URL: str = os.getenv("BINANCE_WS_BASE_URL", "wss://fstream.binance.com")
    ...
    DEVELOPMENT: bool = os.getenv("NODE_ENV", "production") == "development" or DEBUG
    ...
    REQUEST_LOGGING: bool = DEBUG and os.getenv("REQUEST_LOGGING", "True").lower() == "true"
    
    # Static Files Configuration (for development)
    SERVE_STATIC_FILES: bool = DEVELOPMENT and os.getenv("SERVE_STATIC_FILES", "True").lower() == "true"
    STATIC_FILES_PATH: str = os.getenv("STATIC_FILES_PATH", "../frontend_vanilla/dist")
    ...
    def __init__(self):
        ...
        if not self.BINANCE_API_KEY:
            logging.warning("BINANCE_API_KEY not found in environment variables")
        if not self.BINANCE_SECRET_KEY:
            logging.warning("BINANCE_SECRET_KEY not found in environment variables")
    ...
    def _configure_logging(self):
        ...
        if self.DEBUG:
            ...
            logging.getLogger("uvicorn.access").setLevel(logging.INFO if self.REQUEST_LOGGING else logging.WARNING)
