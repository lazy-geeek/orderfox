...
// Trading components removed - not part of PHP backend migration
...
import {
  ...
  fetchOrderBook,
  fetchCandles,
  // Trading functions removed - not part of PHP backend migration
  // fetchOpenPositions,
  // executePaperTrade,
  // executeLiveTrade,
  // setTradingModeApi,
...
// Trading mode toggle removed - not part of PHP backend migration
...
// Trading mode toggle event removed - not part of PHP backend migration
